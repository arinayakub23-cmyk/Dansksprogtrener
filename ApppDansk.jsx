...
const topics = {
  ...
  B: { icon: "⚽", label: "B: Fritid", person: "Jonas går til fodbold", cards: [
    ...
    { id:"klub",  label:"Klub",       scene:"Jonas er med i en fodboldklub.",               wh:["Hvilken","Hvad hedder"],    hint:["klub","fodbold"],    examples:["Hvilken klub er Jonas med i?","Hvad hedder Jonas' klub?"] },
